...
import { Container, InfoClient, FirstSection, SecondSection, ThirdSection, LinkSection, Division, BottomFooter, FirstColumn, LastColumn, MiddleColumn, IconsStyle } from './styles';
                    ...
                    <Division>
                        <FirstSection>
                            ...
                            <div style={{display:'flex', gap:16}}>
                                <IconButton color="inherit" aria-label="instagram" style={{backgroundColor:'white', color:`${colors.uppyRose}`}}>
                                    <Instagram />
                                </IconButton>
                                ...
                                <IconButton color="inherit" aria-label="whastapp" style={{backgroundColor:'white', color:`${colors.uppyRose}`}}>
                                    <WhatsApp />
                                </IconButton>                            
                            </div>
                        </FirstSection>
